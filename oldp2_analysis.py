...
# -*- coding: utf-8 -*-
"""
Created on Fri Mar 28 11:02:04 2025
...
def simple_demography(tsplit, tend, NeA, NeB, NeC, tSweep, NeSweep):
        ...
        phase3=glike.Phase(tsplit,tend, [1/NeA,1/NeBC],  P=np.array([[1,0], [0,1],[0,1]]))
...
NeC=20000
NeBC=20000
demo=simple_demography(2500, 20000, 20000, 20000, 20000, 2000,20000)
...
glike_x0 = {"tsplit":tsplit, "tend":tend, "NeA":NeA, "NeB":NeB,"NeC":NeC, "tSweep":2000, "NeSweep":NeSweep}
 
modern_bounds = [(tsplit,tsplit),(tend,tend),(NeA,NeA), (NeB,NeB), (NeC,NeC), (0, tend), (0,10*Ne)]
...
windows.to_csv( "tsweepp1windowedlr_single_{0}.txt".format(params), sep="\t", index=False)

rcmd="Rscript --vanilla /Users/olj5016/arg_selection/pval.R 'tsweepp2windowedlr_single_{0}.txt'".format(params)
os.system(rcmd)
...
def simple_demography(tsplit, tend, NeA, NeB, NeC, tSweep, NeSweep):
        ...
        phase2=glike.Phase(tsplit,tSweep, [1/NeA,1/NeB], P=np.array([[1,0],[0,1],[0,1]]))
        phase3=glike.Phase(tSweep,tend, [1/NeA,1/NeSweep],  P=np.array([[1,0], [0,1]]))
        phase4=glike.Phase(tend,np.inf, [1/NeA],  P=np.array([[1],[1]]))
        demo.add_phase(phase1)
        demo.add_phase(phase2)
        demo.add_phase(phase3)
...
NeC=20000
NeBC=20000
demo=simple_demography(2500, 20000, 20000, 20000, 20000, tSweep,20000)
...
glike_x0 = {"tsplit":tsplit, "tend":tend, "NeA":NeA, "NeB":NeB,"NeC":NeC, "tSweep":tSweep, "NeSweep":NeSweep}
 
ancient_bounds = [(tsplit,tsplit),(tend,tend),(NeA,NeA), (NeB,NeB), (NeC,NeC), (tsplit, tend), (0,10*Ne)]
...
rcmd="Rscript --vanilla /Users/olj5016/arg_selection/pval.R 'tsweepp1windowedlr_single_{0}.txt'".format(params)
os.system(rcmd)
